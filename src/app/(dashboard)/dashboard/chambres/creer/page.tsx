...
const roomSchema = z.object({
  ...
  status: z.enum(["disponible", "occupee", "reservee", "nettoyage", "maintenance"]).default("disponible"),
...
// ─── Component ──────────────────────────────────────────────────────────
export default function CreerChambrePage() {
    ...
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-6 max-w-2xl">
      ...
      <motion.div variants={item} className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-serif text-2xl font-semibold text-navy">Nouvelle chambre</h1>
            <p className="text-sm text-slate">Ajoutez une chambre à votre établissement.</p>
          </div>
        </div>
      </motion.div>
        ...
        <Card className="rounded-xl border-border shadow-sm">
          <CardContent className="p-6">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              {/* ─── Tarification ──────────────────────────────────── */}
              <div className="space-y-4">
                <h3 className="text-sm font-semibold text-navy uppercase tracking-wide">Tarification</h3>
                <div className="grid gap-4 sm:grid-cols-2">
                  {/* Prix */}
                  <div className="space-y-2">
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-border/50">
                ...
                >
                  {submitting ? (
                    ...
                    <><Plus className="mr-2 h-4 w-4" /> Créer la chambre</>
                  )}
                </Button>
              </div>
            </form>
